...
int main()
{
    ...
    */
    ...
    cout << "#### Lista de exercicios 3 ####" << endl << endl;


    cout << "a) Conta impares: " << a.impares() << endl;
    cout << "b) Soma: " << a.soma() << endl;
    cout << "g) Maiores que (15): " << a.maiores(15) << endl;
    cout << "h) Media nivel (1): " << a.mediaNivel(1) << endl;
